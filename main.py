...
def train(epoch_num, output_path, batch_size):
    ...
    for epoch in range(epoch_num):
        ...
        for batch_idx, (inputs, masks, image_names) in enumerate(train_loader):
            ...
            if batch_idx % 10 == 0:
                ...
                print(f"交叉熵损失：{ce_loss.item()}, tversky_loss:{tversky_loss.item()}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_model", type=str, default='./pth/model.pth')
